			...
			if ("".equals(Server)) {
				...
				builder.setTitle("Guardar").setMessage("¿Guardar los datos Ahora?").setIcon(android.R.drawable.ic_dialog_alert).setPositiveButton("Si", new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialog, int which) {
						AlertDialog.Builder dlgAlert = new AlertDialog.Builder(Config_Activity.this);
						...
						if (OpenErpConnect.TestConnection(Server, Port)) {
							...
							if (oerp == null) {
								...
								Toast msg = Toast.makeText(Config_Activity.this, "Lo Datos Se Guardaron Correctamente.", Toast.LENGTH_SHORT);
								msg.show();
								finish();
							}
						} else {
